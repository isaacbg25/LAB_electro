...
On $v_0$ és la velocitat en direcció $x$ que tenen inicialment les partícules en sortir del filament.
Donat que un cop emeses les partícules, aquestes es veuen accelerades a causa del voltatge aplicat $V_a$; per conservació de l'energia, la velocitat ha de ser:
\begin{equation}
...
En subministrar una diferència de potencial a les plaques s'observa com el raig es desvia cap al càtode\footnote{Les imatges de la desviació electroestàtica (Fig.(\ref{fig: Desv E})) es troben a l'annex (\ref{sec: imatges}) }. Per tant, les partícules de les quals està compost els raigs catòdics tenen una càrrega negativa.
 ...
 r$^2$ = 0.9777, 0.9973, 0.9940, 0.9832. Confirmant que les partícules segueixen una trajectòria parabòlica i, per tant, el camp elèctric generat pel condensador es pot considerar uniforme; tal com havíem proposat. 
\begin{figure}[H]
    \centering
