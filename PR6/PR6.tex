...
\begin{equation}
    \vec{B}=\frac{32\pi nI}{5\sqrt{5}r}\cross10^-7 \hat{z} Wb/m^2.
    \label{eq: B}
\end{equation}
...
\begin{equation}
    R=k\frac{1}{I} \quad on k=\frac{mv5\sqrt{5}r}{32\pi n}\cross 10^7.
    \label{eq: IvsR}
\end{equation}
...
\begin{equation}
    ...
    \label{eq: q/m}
\end{equation}
per calcular la relació $\frac{q}{m}$.
