...
En aquest apartat de la pràctica, després de comprovar que les partícules dels ràigs catòdics tenen càrrega negativa com hem vist a la secció \ref{sec: desv_electr} n'estudiem la interacció amb el camp magnètic, substancialment uniforme, generat per unes bobines de Hemholtz. El camp l'hem direccionat perpendicular als raigs catòdics i n'hem controlat la intensitat regulant la intensitat del corrent de les bobines. Al aplicar el camp hem observat com els ràigs es corbaven i ens hem disposat a estudiar les dependències d'aquesta corba i el seu radi amb la intensitat del corrent de les bobines i el potencial dels raigs catòdics per poder determinar més propietats de les partícules d'aquests. 
