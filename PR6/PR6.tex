...
\begin{figure}[h]
    ...
    \begin{minipage}{0.45\textwidth}
        ...
        \caption{Regressió dels punts experimentals de R en funció de $V_a^2$}
        \label{fig: RvsVa}
    \end{minipage}
    \hfill
    \begin{minipage}{0.45\textwidth} 
        ...
        \begin{tabular}{|c|c|}
            \hline
            Va(V) & R (m)\\\hline
            (2000 ± 200)	&	(0,0880 ± 0,0030)	\\\hline
            (3000 ± 200)	&	(0,1069± 0,0035)	\\\hline
            (4000 ± 200)	&	(0,1204 ± 0,0030)	\\\hline
            (5000 ± 200)	&	(0,1284± 0,0040)	\\\hline
        \end{tabular}
...
\[
\boxed{\frac{q}{m}=(4.16\pm0.38)\cross10^{11}\quad C/Kg.}
\]
...
hem despreciat les incerteses instrumentals de les regressions al ser molt menors a les estadístiques.
